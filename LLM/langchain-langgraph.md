...
async def agent_node(state: AgentState):
    ...
    system_message = SystemMessage("""
                                    You are a helpful assistant that helps users find and understand Airbnb listings.
                                    Use available tools to gather relevant information and present the results clearly and concisely.
                                   """)
    messages = [system_message] + state["messages"]
    response = llm_with_tools.invoke(messages)
